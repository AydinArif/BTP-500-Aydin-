...
#   These are the unit tests for functions and classes of lab 2
#   To use this, run: python test_lab2.py
...
class Lab1TestCase(unittest.TestCase):
    """These are the test cases for functions and classes of lab2"""
